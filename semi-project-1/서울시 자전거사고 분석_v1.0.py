...
# 피해자사고 발생건수가 가장 많은 곳 : <u>송파구</u><br> 가해자사고 발생건수가 가장 많은 곳 : <u> 영등포구</u>
# </span>
...
# <span style="color:blue;">
#     [결과] 인구 수 대비 자전서 사고 발생건수가 가장 많은 곳은 <u>영등포구</u>와 <u>송파구</u>
# </span>
...
# <span style="color:blue;">
# [결과] 인구수 대비 송파구, 종로구, 영등포구에 가장 많은 자전거도로가 있음을 알 수 있음
# </span>

# #### 3) [이용률 대비] 자전거 도로 수 (공공자전거 기준)
...
# 
# 자전거 도로수는 많으나 자전거만 다닐 수 있는 비교적 안전한 자전거 전용도로의 비율이 적음을 알 수 있음 
# 
# </span>